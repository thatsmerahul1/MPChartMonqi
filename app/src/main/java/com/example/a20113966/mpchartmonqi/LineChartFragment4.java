...
public class LineChartFragment4 extends Fragment implements OnSeekBarChangeListener,
...
//        mChart.invalidate();
    ...
    public LineChartFragment4 newInstance(int pos) {

        position = pos;
        LineChartFragment4 f = new LineChartFragment4();
        Bundle b = new Bundle();
        b.putString("msg", pos+"");
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            set1.setFillColor(R.color.purpple);
            set1.setColor(R.color.purpple);
            ...
            if (Utils.getSDKInt() >= 18) {
                // fill drawable only supported on api level 18 and above
                    ...
                    Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.fade_purpple);
