...
public class LineChartFragment3 extends Fragment implements OnSeekBarChangeListener,
...
//        mChart.invalidate();
    ...
    public LineChartFragment3 newInstance(int pos) {

        position = pos;
        LineChartFragment3 f = new LineChartFragment3();
        Bundle b = new Bundle();
        b.putString("msg", pos+"");
