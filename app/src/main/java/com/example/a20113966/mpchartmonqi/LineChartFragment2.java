...
public class LineChartFragment2 extends Fragment implements OnSeekBarChangeListener,
...
//        mChart.invalidate();
    ...
    public LineChartFragment2 newInstance(int pos) {

        position = pos;
        LineChartFragment2 f = new LineChartFragment2();
        Bundle b = new Bundle();
        b.putString("msg", pos+"");
    ...
    private void setData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            set1.setFillColor(R.color.light_yellow);
            set1.setColor(R.color.light_yellow);
